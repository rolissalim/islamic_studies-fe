<div class="btn-toolbar m-t-min-42">
    <div class="btn-group btn-group-sm type-tweets">
        <span class="btn btn-default active" data-type="all">ALL</span>
        <span class="btn btn-default" data-type="tweet">TWEETS</span>
        <span class="btn btn-default" data-type="retweet">RT</span>
        <span class="btn btn-default" data-type="mention">MENTIONS</span>
    </div>
