...
<div class="row">
        ...
        <div class="btn-toolbar">
                    ...
                    <form class="dropdown-menu pull-left form-search-account">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control" name="account_name" placeholder="Search Account Twitter..." required="">
            ...
            <div class="btn-group pull-right">
                ...
                <div class="btn-group sort-data">
                    ...
                    <label class="btn btn-default" data-value="followers_count">
                        Followers
                    </label>
                </div>
            </div>
    ...
    <div class="col-md-7">
        ...
        <div class="btn-toolbar m-t-10">
            <span class="btn disabled pull-right" id="info-list-tweets"></span>
        </div>
    </div>
</div>