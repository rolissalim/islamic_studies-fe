            ...
            <div class="col-md-24">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading text-primary">
                                <h4 class="panel-title">Most Active Followers</h4>
                            </div>
                            <div class="panel-body" id="active-followers"></div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading text-primary">
                                <h4 class="panel-title">Top Accounts Replied</h4>
                            </div>
                            <div class="panel-body" id="most-reply-chart"></div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading text-primary">
                                <h4 class="panel-title">Top Accounts Retweeted</h4>
                            </div>
                            <div class="panel-body" id="most-retweet-chart"></div>
                        </div>
                    </div>
                </div>
            </div>
