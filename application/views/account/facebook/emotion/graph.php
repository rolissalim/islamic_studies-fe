<div class="row">
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading text-primary">
                <div class="btn-group filter-period pull-top">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <ul class="list-unstyled pull-right chart-menu" id="type-chart">
                    <li><span class="btn btn-default active" data-type="radar">RADAR CHART</span></li>
                    <li><span class="btn btn-default" data-type="area">STACKED AREA</span></li>
                    <li><span class="btn btn-default" data-type="bar">STACKED BAR</span></li>
                    <!--<li><span class="btn btn-default" data-type="sunburst">SUNBURST</span></li>-->
                    <li><span class="btn btn-default" data-type="treemaps">TREE MAPS</span></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="col-md-18">
        <div class="panel panel-default">
            <div class="panel-body" id="detail-chart">
            </div>
        </div>
    </div>
</div>