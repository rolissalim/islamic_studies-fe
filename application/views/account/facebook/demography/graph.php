    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">Age Separation</h4>
            </div>
            <div class="panel-body" id="age-chart"></div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">Religion Preferences</h4>
            </div>
    ...
    <div class="col-md-18">
        <div class="row" >
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Gender Category</h4>
                    </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="device-chart"></div>
                </div> 
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading p-t-0">
                <h4 class="panel-title">Account Locations</h4>
            </div>
