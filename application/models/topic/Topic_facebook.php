...
class Topic_facebook extends Api_response {

    function __construct() {
        parent::__construct();
        $this->_api_host = $this->config->item('app_api_topic_facebook');
     ...
     * @return type
     */
    public function get_compare_exposure($params, $period = NULL, $year = NULL, $month = NULL) {
        $url = $this->_api_host . "/get_compare_exposure";
        $query = array(
            'year' => $year,
            'month' => $month,
        );
    ...
    public function get_check_report_resume($topic_id, $media, $sdate, $edate, $timeframe) {
        // Bandung Resume Facebook monthly report (17 July 2017 until 15 August 2017).xlsx
        $return = array();
        $file_type = ".xlsx";
