...
class Topic_instagram extends Api_response {

    function __construct() {
        parent::__construct();
        $this->_api_host = $this->config->item('app_api_topic_instagram');
     ...
     * @return type
     */
    public function get_ig_posts($params, $start = 0, $rows = 15, $keyword = NULL, $period = NULL) {
    ...
    public function get_check_report_resume($topic_id, $media, $sdate, $edate, $timeframe) {
        // Bandung Resume Instagram monthly report (17 July 2017 until 15 August 2017).xlsx
        $return = array();
        $file_type = ".xlsx";
