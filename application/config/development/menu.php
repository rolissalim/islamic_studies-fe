...
$config['app_menu'] = array(
    'Home' => array(
        ...
        'Overview' => array(
            'twitter' => array(
                'Index' => 'home/overview/twitter'
            ),
//            'facebook' => array(
//                'Index' => 'home/overview/facebook'
//            )
        ),
        'Personalize' => array(
...
//                'Streaming' => 'account/instagram/emotion/streaming'
    ...
    'Topic' => array(
        'twitter' => array(
            ...
            //)
            'Reporting' => 'topic/twitter/reporting',
        ),
        'facebook' => array(
            'Index' => 'topic/facebook/main',
...
//                'Demography Analysis' => 'topic/facebook/sentiments/demography'
            ),
            'Reporting' => 'topic/facebook/reporting',
        ),
        'youtube' => array(
            'Index' => 'topic/youtube/main',
            'Dashboard' => 'topic/youtube/dashboard',
            'Chronology' => array(
                'Timeline' => 'topic/youtube/chronology/timeline',
                'Streaming' => 'topic/youtube/chronology/streaming'
            ),
            'Issues' => array(
                'Cluster' => 'topic/youtube/issues/cluster',
                'Comparison' => 'topic/youtube/issues/comparison'
            ),
            'Emotion' => array(
                'Graph Analysis' => 'topic/youtube/emotion/graph',
                'Text Analysis' => 'topic/youtube/emotion/text',
                'History' => 'topic/youtube/emotion/history',
            ),
            'Sentiments' => array(
                'Text Analysis' => 'topic/youtube/sentiments',
            ),
            'Audience' => array(
                'Statistic' => 'topic/youtube/audience/statistic',
            ),
        ),
        'instagram' => array(
            'Index' => 'topic/instagram/main',
            'Dashboard' => 'topic/instagram/dashboard',
            'Chronology' => array(
                'Timeline' => 'topic/instagram/chronology/timeline',
                'Streaming' => 'topic/instagram/chronology/streaming'
            ),
            'Issues' => array(
                'Cluster' => 'topic/instagram/issues/cluster',
                'Comparison' => 'topic/instagram/issues/comparison'
            ),
            'Emotion' => array(
                'Graph Analysis' => 'topic/instagram/emotion/graph',
                'Text Analysis' => 'topic/instagram/emotion/text',
                'History' => 'topic/instagram/emotion/history',
            ),
            'Sentiments' => array(
                'Text Analysis' => 'topic/instagram/sentiments',
            ),
            'Audience' => array(
                'Statistic' => 'topic/instagram/audience/statistic',
            ),
        ),
        'forum_comments' => array(
            ...
            'Sentiments' => array(
                'Text Analysis' => 'topic/forum_comments/sentiments',
//                'Demography Analysis' => 'topic/forum_comments/sentiments/demography'
            ),
        ),
        'news_comments' => array(
            ...
            'Sentiments' => array(
                'Text Analysis' => 'topic/news_comments/sentiments',
//                'Demography Analysis' => 'topic/news_comments/sentiments/demography'
            ),
        ),
    ),
    'Action' => array(
